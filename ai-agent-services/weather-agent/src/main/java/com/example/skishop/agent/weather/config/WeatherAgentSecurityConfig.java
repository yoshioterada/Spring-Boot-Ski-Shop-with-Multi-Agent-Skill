...
/**
 * Weather Agent の SecurityConfig（分散モードのみ有効化）。
 * モノリス時は agent-runtime-monolith 側の MonolithSecurityConfig が処理する。
 */
@Configuration
@EnableWebSecurity
...
public class WeatherAgentSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain weatherAgentFilterChain(HttpSecurity http,
